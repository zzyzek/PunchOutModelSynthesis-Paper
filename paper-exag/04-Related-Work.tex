...
For example, finding a small tileable block that is then able to be replicated through to the whole grid might be possible
...
In such cases, running MMS is pointless, as MMS can't start without a solution but if a solution is known, MMS wouldn't
be needed.
...
\begin{table}[h]
  ...
  \begin{tabular}[t]{lcccccc}
    \hline
    Algorithm & Block Level Solver & Grid Level Solver & Contradiction Resiliance & Block Step Consistent & Inderminate Initial State & Ergodic  \\
    \hline
    Gumin's Wave Function Collapse (WFC)              & Yes & No  & No  & n/a & Yes & Yes \\
    Breakout Model Synthesis (BMS)                    & Yes & No  & Yes & n/a & Yes & Yes \\
    Merrell's Modify in Blocks Model Synthesis (MMS)  & No  & Yes & Yes & Yes & No  & No \\
    Punch Out Model Synthesis (POMS)                  & No  & Yes & Yes & No  & Yes & Yes \\
    \hline
  \end{tabular}
\end{table}
