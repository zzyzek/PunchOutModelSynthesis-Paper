...
The first two tile sets that appear in Figure \ref{fig:2dexamples}, \textit{Pill Mortal} and LUNARSIGNAL's \textit{Overhead Action RPG Overworld} tile set, both
...
The reader is referred to the reference implementation \footnote{ \url{https://github.com/zzyzek/POMS} } for further details.
